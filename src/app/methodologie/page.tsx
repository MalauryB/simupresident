...
function SectionCard({
  ...
  return (
    <div
      id={id}
      className="rounded-xl border-l-4 border-l-primary bg-white p-6 shadow-sm"
    >
    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-12 border-b border-gray-200 pb-8">
        ...
        <a
          ...
          download
          className="inline-flex items-center gap-2 rounded-xl border border-primary px-4 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary hover:text-white"
        >
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <SectionCard title="1) Les blocs id&eacute;ologiques">
              ...
              <div className="rounded-lg border-l-2 border-gray-300 bg-gray-50 pl-4 py-3 italic">
        ...
        {/* ---- Limites du modele ---- */}
        <div className="rounded-xl border-l-4 border-l-amber-500 bg-amber-50/50 p-6 shadow-sm">
